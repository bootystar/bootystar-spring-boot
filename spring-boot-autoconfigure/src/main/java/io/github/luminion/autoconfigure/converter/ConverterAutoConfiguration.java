...
public class ConverterAutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-local-date-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-local-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-local-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-sql-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-sql-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminion.converter.string-to-sql-timestamp", havingValue = "true", matchIfMissing = true)

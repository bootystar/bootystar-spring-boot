package io.github.luminsyn.autoconfigure.converter;

import io.github.luminsyn.autoconfigure.DateTimeFormatProperties;
import io.github.luminsyn.autoconfigure.converter.support.*;
...
@Slf4j
@AutoConfiguration
@ConditionalOnProperty(value = "luminsyn.converter.auto", havingValue = "true", matchIfMissing = true)
@EnableConfigurationProperties({ConverterProperties.class, DateTimeFormatProperties.class})
public class ConverterAutoConfiguration {

    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-local-date-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-local-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-local-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-sql-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-sql-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luminsyn.converter.string-to-sql-timestamp", havingValue = "true", matchIfMissing = true)

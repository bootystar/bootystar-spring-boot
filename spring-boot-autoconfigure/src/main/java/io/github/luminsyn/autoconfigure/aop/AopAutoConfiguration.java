package io.github.luminsyn.autoconfigure.aop;

import io.github.luminsyn.autoconfigure.aop.aspectj.RateLimitAspect;
import io.github.luminsyn.autoconfigure.aop.spi.RateLimiter;
import io.github.luminsyn.autoconfigure.aop.spi.SignatureProvider;
import io.github.luminsyn.autoconfigure.aop.spi.limiter.ConcurrentHashMapRateLimiter;
import io.github.luminsyn.autoconfigure.aop.spi.signature.SpelSignatureProvider;
...
@ConditionalOnProperty(prefix = "luminsyn.aop", name = "enabled", havingValue = "true", matchIfMissing = true)

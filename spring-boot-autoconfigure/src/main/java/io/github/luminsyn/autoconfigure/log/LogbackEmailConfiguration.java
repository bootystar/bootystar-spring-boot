package io.github.luminsyn.autoconfigure.log;
...
public class LogbackEmailConfiguration implements ApplicationListener<ApplicationFailedEvent> {
    ...
    @Value("${luminsyn.log.email.to:}") // Expects a comma-separated list
    ...
    public void addEmailAppenderToLogback() {
        if (toAddresses == null || toAddresses.length == 0) {
            System.err.println("EmailAppender not configured: 'luminsyn.log.email.to' is not set.");
            return;
        }

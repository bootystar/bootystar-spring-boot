package io.github.luxmixus.autoconfigure.aop;

import io.github.luxmixus.autoconfigure.aop.aspectj.RateLimitAspect;
import io.github.luxmixus.autoconfigure.aop.spi.RateLimiter;
import io.github.luxmixus.autoconfigure.aop.spi.SignatureProvider;
import io.github.luxmixus.autoconfigure.aop.spi.limiter.ConcurrentHashMapRateLimiter;
import io.github.luxmixus.autoconfigure.aop.spi.signature.SpelSignatureProvider;
...
@ConditionalOnProperty(prefix = "luxmixus.aop", name = "enabled", havingValue = "true", matchIfMissing = true)

package io.github.luxmixus.autoconfigure.aop.spi.writer;
...
public class EmailLogWriter extends RequestLogWriter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        javaMailSender.setUsername("luxmixus@163.com");
        javaMailSender.setPassword(System.getProperty("163_MAIL_PWD")); 

        MimeMessage mimeMessage = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true, "UTF-8");
        helper.setFrom("luxmixus@163.com");
        helper.setTo("luxmixus@qq.com"); // 收件人

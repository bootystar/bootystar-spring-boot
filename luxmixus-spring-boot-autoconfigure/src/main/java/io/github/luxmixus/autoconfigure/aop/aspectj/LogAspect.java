package io.github.luxmixus.autoconfigure.aop.aspectj;

import io.github.luxmixus.autoconfigure.aop.spi.LogWriter;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(io.github.luxmixus.autoconfigure.aop.annotation.Log)")

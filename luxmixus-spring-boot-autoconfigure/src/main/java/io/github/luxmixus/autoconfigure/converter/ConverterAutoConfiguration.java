package io.github.luxmixus.autoconfigure.converter;

import io.github.luxmixus.autoconfigure.DateTimeFormatProperties;
import io.github.luxmixus.autoconfigure.converter.support.*;
...
@Slf4j
@AutoConfiguration
@ConditionalOnProperty(value = "luxmixus.converter.auto", havingValue = "true", matchIfMissing = true)
@EnableConfigurationProperties({ConverterProperties.class, DateTimeFormatProperties.class})
public class ConverterAutoConfiguration {

    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-local-date-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-local-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-local-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-sql-date", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-sql-time", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "luxmixus.converter.string-to-sql-timestamp", havingValue = "true", matchIfMissing = true)

package io.github.luxmixus.autoconfigure.excel;

import io.github.luxmixus.autoconfigure.DateTimeFormatProperties;
import io.github.luxmixus.autoconfigure.excel.easyexcel.EasyExcelConverterRegister;
import io.github.luxmixus.autoconfigure.excel.fastexcel.FastExcelConverterRegister;
...
@Slf4j
@AutoConfiguration
@ConditionalOnProperty(value = "luxmixus.excel.auto", havingValue = "true", matchIfMissing = true)
